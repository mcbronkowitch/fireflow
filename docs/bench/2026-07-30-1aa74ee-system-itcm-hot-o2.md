...
102.66 % / 102.74 %; Run 2 102.71 % / 102.75 %. Across both repeats, the worst
maxima are **102.71 % offline** and **102.75 % in the real callback**.
**Conclusion: the DTCM+BBD gate does not fit.** O2 is valid, deterministic
control evidence and remains archived, but it is over the strict 100 % stop
gate in every offline and callback maximum.
