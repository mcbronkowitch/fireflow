...
4. **DRIVE has makeup gain after the saturator** (Task 5). Without it, FEEDBACK means something different at every DRIVE setting and the two knobs fight. Ear pass item.
