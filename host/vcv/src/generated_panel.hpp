...
static const ModTarget kModLayer[] = {
    {SOURCE_A, MODD_SOURCE_A, 0, 0, 0, "SOURCE A mod depth (left of noon: S&H, right: continuous)"},
    {SOURCE_B, MODD_SOURCE_B, 0, 0, 1, "SOURCE B mod depth (left of noon: S&H, right: continuous)"},
    {DEPTH_A, MODD_DEPTH_A, 0, 3, 0, "DEPTH A mod depth (left of noon: S&H, right: continuous)"},
    {DEPTH_B, MODD_DEPTH_B, 0, 3, 1, "DEPTH B mod depth (left of noon: S&H, right: continuous)"},
    {FILT_A, MODD_FILT_A, 0, 1, 0, "FILT A mod depth (left of noon: S&H, right: continuous)"},
    {FILT_B, MODD_FILT_B, 0, 1, 1, "FILT B mod depth (left of noon: S&H, right: continuous)"},
    {FLUX_A, MODD_FLUX_A, 1, 2, 0, "FLUX A mod depth (left of noon: S&H, right: continuous)"},
    {FLUX_B, MODD_FLUX_B, 1, 2, 1, "FLUX B mod depth (left of noon: S&H, right: continuous)"},
    {FLUXFB_A, MODD_FLUXFB_A, 1, 4, 0, "FLUXFB A mod depth (left of noon: S&H, right: continuous)"},
    {FLUXFB_B, MODD_FLUXFB_B, 1, 4, 1, "FLUXFB B mod depth (left of noon: S&H, right: continuous)"},
    {REV_MIX_A, MODD_REV_MIX_A, 1, 3, 0, "REV_MIX A mod depth (left of noon: S&H, right: continuous)"},
    {REV_MIX_B, MODD_REV_MIX_B, 1, 3, 1, "REV_MIX B mod depth (left of noon: S&H, right: continuous)"},
    {RATE_A, MODD_RATE_A, 2, 1, 0, "RATE A mod depth (left of noon: S&H, right: continuous)"},
    {RATE_B, MODD_RATE_B, 2, 1, 1, "RATE B mod depth (left of noon: S&H, right: continuous)"},
    {SHAPE_A, MODD_SHAPE_A, 2, 3, 0, "SHAPE A mod depth (left of noon: S&H, right: continuous)"},
    {SHAPE_B, MODD_SHAPE_B, 2, 3, 1, "SHAPE B mod depth (left of noon: S&H, right: continuous)"},
    {DENSITY_A, MODD_DENSITY_A, 2, 3, 0, "DENSITY A mod depth (left of noon: S&H, right: continuous)"},
    {DENSITY_B, MODD_DENSITY_B, 2, 3, 1, "DENSITY B mod depth (left of noon: S&H, right: continuous)"},
    {SMOOTH_A, MODD_SMOOTH_A, 2, 1, 0, "SMOOTH A mod depth (left of noon: S&H, right: continuous)"},
    {SMOOTH_B, MODD_SMOOTH_B, 2, 1, 1, "SMOOTH B mod depth (left of noon: S&H, right: continuous)"},
    {RANGE_A, MODD_RANGE_A, 2, 1, 0, "RANGE A mod depth (left of noon: S&H, right: continuous)"},
    {RANGE_B, MODD_RANGE_B, 2, 1, 1, "RANGE B mod depth (left of noon: S&H, right: continuous)"},
    {MELODY_A, MODD_MELODY_A, 2, 4, 0, "MELODY A mod depth (left of noon: S&H, right: continuous)"},
    {MELODY_B, MODD_MELODY_B, 2, 4, 1, "MELODY B mod depth (left of noon: S&H, right: continuous)"},
    {SUB_A, MODD_SUB_A, 2, 4, 0, "SUB A mod depth (left of noon: S&H, right: continuous)"},
    {SUB_B, MODD_SUB_B, 2, 4, 1, "SUB B mod depth (left of noon: S&H, right: continuous)"},
    {DETUNE_A, MODD_DETUNE_A, 2, 0, 0, "DETUNE A mod depth (left of noon: S&H, right: continuous)"},
    {DETUNE_B, MODD_DETUNE_B, 2, 0, 1, "DETUNE B mod depth (left of noon: S&H, right: continuous)"},
    {ATTACK_A, MODD_ATTACK_A, 2, 3, 0, "ATTACK A mod depth (left of noon: S&H, right: continuous)"},
    {ATTACK_B, MODD_ATTACK_B, 2, 3, 1, "ATTACK B mod depth (left of noon: S&H, right: continuous)"},
    {DECAY_A, MODD_DECAY_A, 2, 3, 0, "DECAY A mod depth (left of noon: S&H, right: continuous)"},
    {DECAY_B, MODD_DECAY_B, 2, 3, 1, "DECAY B mod depth (left of noon: S&H, right: continuous)"},
    {RES_A, MODD_RES_A, 2, 1, 0, "RES A mod depth (left of noon: S&H, right: continuous)"},
    {RES_B, MODD_RES_B, 2, 1, 1, "RES B mod depth (left of noon: S&H, right: continuous)"},
    {COLOR_A, MODD_COLOR_A, 2, 3, 0, "COLOR A mod depth (left of noon: S&H, right: continuous)"},
    {COLOR_B, MODD_COLOR_B, 2, 3, 1, "COLOR B mod depth (left of noon: S&H, right: continuous)"},
    {TUNE_A, MODD_TUNE_A, 2, 2, 0, "TUNE A mod depth (left of noon: S&H, right: continuous)"},
    {TUNE_B, MODD_TUNE_B, 2, 2, 1, "TUNE B mod depth (left of noon: S&H, right: continuous)"},
    {LINK_A, MODD_LINK_A, 2, 4, 0, "LINK A mod depth (left of noon: S&H, right: continuous)"},
    ...
    {REV_TONE, MODD_REV_TONE, 2, 1, 2, "REV_TONE mod depth (left of noon: S&H, right: continuous)"},
    {REV_DIFF, MODD_REV_DIFF, 2, 1, 2, "REV_DIFF mod depth (left of noon: S&H, right: continuous)"},
    {TIDE, MODD_TIDE, 2, 1, 2, "TIDE mod depth (left of noon: S&H, right: continuous)"},
};
